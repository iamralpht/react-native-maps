...
const propTypes = {
  ...
  /**
   * If `true` the map will rotate to show the user's heading. This only works if
   * `followsUserLocation` is true and the user has shared their location.
   * Default value is `false`.
   *
   * @platform ios
   */
  followsUserHeading: PropTypes.bool,
